# Contributing
Thank you for considering contributing to Poortman! Read the guidelines and installation documentation below.
...
## :tada: Using
As Poortman is build with [Laravel Zero](https://laravel-zero.com/) read their documentation thoroughly.

Use the Poortman/Laravel Zero commands by running:
```shell
php poortman
```
...
Please review our [Code of Conduct](https://github.com/magewirephp/poortman/blob/main/CODE_OF_CONDUCT.md). It is in effect at all times. We expect it to be honored by everyone who contributes to this project. Acting like an asshole will not be tolerated.

## :bulb: Asking Questions

See our [Support Guide](https://github.com/magewirephp/poortman/blob/main/SUPPORT.md). In short, GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Review our [Security Policy](https://github.com/magewirephp/poortman/blob/main/SECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Review the documentation and [Support Guide](https://github.com/magewirephp/poortman/blob/main/SUPPORT.md)** before opening a new issue.
